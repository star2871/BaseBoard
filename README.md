...
BASEBOARD는 야구팀의 성과를 분석하고 선수들의 컨디션을 관리하기 위한 웹 기반 대시보드 애플리케이션입니다. `baseball_dashboard_architecture.pdf` 및 `야구앱 기획문서.pdf`를 기반으로 설계되었으며, 실시간 경기 데이터, 선수 피로도 관리, 팀 성적 분석, 이동 일정 관리 등 다양한 기능을 제공합니다.
